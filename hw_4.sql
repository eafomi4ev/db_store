...
(
    ...
    CONSTRAINT FK_store_id FOREIGN KEY (store_id) REFERENCES public.store (id)
);
...
-- ALTER TABLE product.price_list ALTER COLUMN product_id TYPE bigint USING product_id::bigint;
-- ALTER TABLE product.price_list ALTER COLUMN store_id TYPE integer USING store_id::integer;
-- ALTER TABLE product.price_list ADD CONSTRAINT FK_product_id FOREIGN KEY (product_id) REFERENCES product.product (id);
-- ALTER TABLE product.price_list ADD CONSTRAINT FK_store_id FOREIGN KEY (store_id) REFERENCES public.store (id);
